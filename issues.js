...
var options = {
  ...
  privateToken: 'hSD3kJgLbsRiyepZ3sZ1',
...
var client = gitlab.create({
  url: 'https://gitlab.com/julianamayumi_/test-issues.git',
  privateToken: 'hSD3kJgLbsRiyepZ3sZ1'
});
...
function createIssue(data) {
  client.issues.create({
    ...
    if (success) {
      console.log("Issue " + data.title + " criada!");
    } else {
      console.log(data.title + " NÃO CRIADA! \n" +
        err + "\n Try upping the timeoutValue in the options object");

      failures.push(data);
      console.log(failures.length + ' falhas até agora');
